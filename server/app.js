...
app.post('/getMemberDB', function(req,res){
  ...
  pg.connect(connectionString, function(err, client, done){
    if (err){
      ...
      var membersQueryRes=client.query('(SELECT *, 1 AS thisMem '+
      'FROM members_join_info WHERE log_email=\''+memberSearch+'\' '+
      ...
      'FROM members_join_groups WHERE log_email=\''+memberSearch+'\')) '+
